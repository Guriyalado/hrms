...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('/goals/print', 'GoalController@print');
	Route::get('/goals/create', 'GoalController@create');
	Route::post('/goals/store', 'GoalController@store');
	Route::get('/goals/active/{id}', 'GoalController@active');
	Route::get('/goals/deactive/{id}', 'GoalController@deactive');
	Route::get('/goals/details/{id}', 'GoalController@show');
	Route::get('/goals/download-pdf/{id}', 'GoalController@pdf');
	Route::get('/goals/edit/{id}', 'GoalController@edit');
	Route::post('/goals/update/{id}', 'GoalController@update');
	Route::get('/goals/delete/{id}', 'GoalController@destroy');
