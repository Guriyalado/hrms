...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="col-md-3">
                    <a href="<?php echo e(url('/people/clients/create')); ?>" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> <?php echo e(__('Add Customer')); ?></a>
                </div>
                <div class="col-md-3">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                   <a href="<?php echo e(url('/people/clients/edit/' . $client['id'])); ?>"><i class="icon fa fa-edit"></i> <?php echo e(__('Edit')); ?></a>
                                </td>
                            </tr>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u885534217/domains/pyzenlabs.com/public_html/subdomain/hrms/resources/views/administrator/people/client/manage_clients.blade.php ENDPATH**/ ?>