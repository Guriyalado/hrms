    ...
    <section class="content">
        ...
        <div class="box box-default">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group<?php echo e($errors->has('display_name') ? ' has-error' : ''); ?> has-feedback">
                            <input type="text" name="display_name" id="display_name" class="form-control" value="<?php echo e($role->display_name); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('description') ? ' has-error' : ''); ?> has-feedback">
                            <input type="text" name="description" id="description" class="form-control" value="<?php echo e($role->description); ?>">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group<?php echo e($errors->has('permission[]') ? ' has-error' : ''); ?> has-feedback">
                         ...
                         <input type="checkbox" <?php echo e(in_array($permission->id,$role_permissions)?"checked":""); ?>   name="permission[]" value="<?php echo e($permission->id); ?>" > <?php echo e($permission->name); ?> <br>
         ...
         <div class="box-footer">
            ...
            <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i> <?php echo e(__('Update Role')); ?></button>
        </div>
    </form>
</div>
<!-- /.box -->
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u885534217/domains/pyzenlabs.com/public_html/subdomain/hrms/resources/views/administrator/setting/role/edit.blade.php ENDPATH**/ ?>