<div id="mainMenu">
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
            <a href="#">
                <i class="fa fa-users"></i> <span><?php echo e(__('Goal Management')); ?></span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
...
</div><?php /**PATH C:\xampp1\htdocs\hrms_guriya\resources\views/administrator/layouts/menu.blade.php ENDPATH**/ ?>