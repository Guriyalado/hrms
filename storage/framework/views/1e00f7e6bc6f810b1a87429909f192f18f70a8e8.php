          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <!-- /.form-group -->
                ...
                <label for="during_leave"><?php echo e(__('Bottom Section')); ?> <span class="text-danger"></span></label>
              <div class="form-group<?php echo e($errors->has('during_leave') ? ' has-error' : ''); ?> has-feedback">
                <input type="text" name="during_leave" id="during_leave" class="form-control" value="<?php echo e(old('during_leave')); ?>" placeholder="<?php echo e(__('Therefore, I request you to kindly grant me leave for .. Enter here')); ?>">
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u885534217/domains/pyzenlabs.com/public_html/subdomain/hrms/resources/views/administrator/hrm/leave_application/add_leave_application.blade.php ENDPATH**/ ?>