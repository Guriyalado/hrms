        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="col-md-12">
                    ...
                    <a href="<?php echo e(url('/hrm/leave-reports/pdf-reports')); ?>" class="btn btn-info btn-flat pull-right"><i class="fa fa-print"></i><?php echo e(__('PDF')); ?> </a>
                </div>
                <br><br>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u885534217/domains/pyzenlabs.com/public_html/subdomain/hrms/resources/views/administrator/hrm/leave_application/leave_report.blade.php ENDPATH**/ ?>